...
@section('content')
    ...
    <section class="content">
        <div class="card">
            <form method="post" id="form-submit" action="{{ route('admin.rooms.update', ['id' => $room->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body" >
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-success mb-5 btn-lg btn-block">Lưu chỉnh sửa</button>
                    </div>
                </div>
            </form>
            <!-- /.card-body -->
